    ...
    a.MixItUp = function() {
        ...
        _processClick: function(c, d) {
            ...
            if (e._execAction("_processClick", 0, arguments), !e._mixing || e.animation.queue && e._queue.length < e.animation.queueLimit) {
                ...
                if ("filter" === d) {
                    var i, h = c.attr("data-filter"),
                        j = "or" === e.controls.toggleLogic ? "," : "";
                    e.controls.toggleFilterButtons ? (e._buildToggleArray(), c.hasClass(e.controls.activeClass) ? (f(c, d, !0), i = e._toggleArray.indexOf(h), e._toggleArray.splice(i, 1)) : (f(c, d), e._toggleArray.push(h)), e._toggleArray = a.grep(e._toggleArray, function(a) {
                        return a
                    }), e._toggleString = e._toggleArray.join(j), e.filter(e._toggleString)) : c.hasClass(e.controls.activeClass) || (a(e.selectors.filter).removeClass(e.controls.activeClass), f(c, d), e.filter(h))
                }
        ...
        _buildToggleArray: function() {
            ...
            if (a._execAction("_buildToggleArray", 0, arguments), "or" === a.controls.toggleLogic) a._toggleArray = b.split(",");
                ...
                for (var d, c = 0; d = a._toggleArray[c]; c++) a._toggleArray[c] = "." + d
            }
        ...
        _updateControls: function(c, d) {
            ...
            for (var j = 0; j < 2; j++) i = e.controls.live ? a(e.selectors[h]) : e["_$" + h + "Buttons"], i && g(i, "[data-" + h + '="' + f[h] + '"]'), h = "sort";
        ...
        _compare: function(a, b, c) {
            ...
            return g < h ? "asc" === e ? -1 : 1 : g > h ? "asc" === e ? 1 : -1 : g === h && d._newSort.length > c + 1 ? d._compare(a, b, c + 1) : 0
        },
        ...
        _getTargetData: function(a, b) {
            var d, c = this;
            a.dataset[b + "PosX"] = a.offsetLeft, a.dataset[b + "PosY"] = a.offsetTop, c.animation.animateResizeTargets && (d = c._suckMode ? {
                marginBottom: "",
                marginRight: ""
            } : window.getComputedStyle(a), a.dataset[b + "MarginBottom"] = parseInt(d.marginBottom), a.dataset[b + "MarginRight"] = parseInt(d.marginRight), a.dataset[b + "Width"] = a.offsetWidth, a.dataset[b + "Height"] = a.offsetHeight)
        },
        ...
        _animateTargets: function() {
            ...
            for (var c = 0; c < b._$toHide.length; c++) {
                for (var d = b._$toHide[c], e = a(d), g = b._getDelay(c), k = {}, i = 0; i < 2; i++) {
                    var j = 0 === i ? j = b._prefix : "";
        ...
        _getPrefixedCSS: function(a, b, c) {
            var d = this,
                ...
                f = "",
                g = -1;
            for (g = 0; g < 2; g++) f = 0 === g ? d._prefix : "", c ? e[f + a] = f + b : e[f + a] = b;
